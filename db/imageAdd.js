...
//         <td class="text-center">${imageTableView.label}</td>
//         <td class="text-center">${t10}</td>
//         <td align-middle"><a href="../../upload/artist_update.html?id=${imageTableView.label}"><i class="far fa-edit"></i></a></td>            
//         <td align-middle"><a onclick="del('${imageTableView.label}')"><i class="fas fa-trash"></i></a></td>            
//         </tr>
//             `
//     });
