...
const newsTable = async () => {
    ...
    newsTableData.docs.forEach(doc =>{
        i++;
        // moment.locale('ar');  
        // const t1 = doc.data().created.toMillis();
        ...
        <td class="text-center">${Date(newsTableView.timestamp)}</td>
        <td align-middle"><a href="./deactive.js?id=${newsTableView.label}"><i class="far fa-edit"></i></a></td>            
